...
class ExpiredProjectReportCommandTest extends TestCase
{
    ...
    public function test_the_message_will_have_a_code_if_there_were_active_projects_that_have_expired_last_week()
    {
    ...
    public function test_a_notification_will_be_sent_if_there_were_active_projects_that_have_expired_last_week()
    {
        Project::factory()->expiredWithStatus(7)->create();
        ...
        Notification::assertSentTo($this->admin, ProjectExpirationReportNotification::class);
    }
}
